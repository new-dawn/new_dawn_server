...
class UserActionTest(ResourceTestCaseMixin, TestCase):
    ...
    def test_message_user(self, send):
        ...
        self.assertEqual(res_data["object_dict"]["end_user_id_1"][0]["user_from_id"], 1)
        self.assertEqual(res_data["object_dict"]["end_user_id_1"][0]["user_to_id"], 2)
        self.assertEqual(res_data["object_dict"]["end_user_id_1"][0]["message"], "How are you")
        self.assertEqual(res_data["object_dict"]["end_user_id_1"][1]["user_from_id"], 2)
        self.assertEqual(res_data["object_dict"]["end_user_id_1"][1]["user_to_id"], 1)
