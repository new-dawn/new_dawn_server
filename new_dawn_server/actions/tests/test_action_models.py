...
class LikeTest(TestCase):
    ...
    def test_get_user_likes(self):
        ...
        self.assertEqual(test_like_obj.like_metadata.entity_type, "Picture")
    ...
    def test_get_multiple_user_likes(self):
        ...
        self.assertEqual(test_like_objs[0].like_metadata.entity_type, "Picture")
        ...
        self.assertEqual(test_like_objs[1].like_metadata.entity_type, "Answer")
